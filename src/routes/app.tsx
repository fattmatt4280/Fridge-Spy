...
export const Route = createFileRoute("/app")({
  head: () => ({
    meta: [
      { title: "Your Kitchen — FridgeSpy" },
      { name: "description", content: "Your FridgeSpy dashboard — what's in your kitchen, what's expiring, and what to cook tonight." },
  ...
  return (
    <div className="px-4 pt-[max(env(safe-area-inset-top),1rem)]">
      ...
      <header className="flex items-center justify-between py-3">
        <Link to="/app" aria-label="FridgeSpy home"><Logo /></Link>
